<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($password !== $confirm_password) {
            ...
            $sql = "INSERT INTO akun (user, katasandi) VALUES (?, ?)";
  ...
  <body>
    ...
    <div class="home-login">
        ...
        <div class="login-contain">
            <div class="ui-login">
                <h1 style="font-weight: 0100px;">Sign Up</h1>
                <div class="garis"></div>
                <form method="POST">
                    ...
                    <input type="password" name="confirm_password" id="confirm_password" placeholder="Confirm Password" onfocus="showPassword()" onblur="hidePassword()" required> <br> <br>
                    <button type="submit" name="login" id="login" style="margin-top: 30px;">Sign Up</button> <br>
                    <a href="login.php" style="margin-right: 400px;"><img src="back.png" width="8%"></a>
                </form>
            </div>
        </div>
    </div>
